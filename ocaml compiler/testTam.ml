...
let runtamcmde = "java -jar ../../fichiersRat/runtam.jar"
(* let runtamcmde = "java -jar /mnt/n7fs/.../tools/runtam/runtam.jar" *)

let getn name= "selftouhTAM_"^name
...
let runtamcode cmde ratfile =
  ...
  close_in ic;
  let t::_=List.rev (String.split_on_char '/' ratfile) in 
  let nomFichier::_ = (String.split_on_char '.' t) in 
  Code.ecrireFichier ((getn (nomFichier))^".tam") tamcode;
  String.trim printed
...
(*let tst=print_string ((compiler fichier)^"\n\n RESULTAT : \n\n"^runtamcode runtamcmde fichier)*)

let fichier="../../fichiersRat/ExempleSujet2.rat" 
let tst=runtam fichier
(* let fichier="../../fichiersRat/testStruct1.rat" 
let tst=runtam fichier
let fichier="../../fichiersRat/testStruct2.rat" 
let tst=runtam fichier
let fichier="../../fichiersRat/testStruct3.rat" 
let tst=runtam fichier
let fichier="../../fichiersRat/testStruct4.rat" 
let tst=runtam fichier
let fichier="../../fichiersRat/testStruct5.rat" 
let tst=runtam fichier
let fichier="../../fichiersRat/testStruct6.rat" 
let tst=runtam fichier

let fichier="../../fichiersRat/testStruct.rat" 
let tst=runtam fichier *)
