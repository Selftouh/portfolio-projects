...
type variable = Ident of string | Var of variable | Champ of variable * string
...
type expression =
  ...
  | AllocationDynamique of typ
  | Adresse of string
  | ListeVal of expression list
...
and instruction =
  ...
  (** *)
  | AssignationAddition of variable * expression
  ...
  type typeNomme =TypeNomme of string*typ
...
type programme = Programme of typeNomme list * fonction list * bloc
...
struct
  ...
  type variable = Ident of Tds.info_ast | Var of variable | Champ of variable * Tds.info_ast
  ...
  and instruction =
    ...
    | Affectation of  variable * expression (* le nom de l'identifiant est remplacé par ses informations *)
    | AssignationAddition of  variable  * expression
    | Affichage of expression
    | Conditionnelle of expression * bloc * bloc
    | TantQue of expression * bloc
  ...
  type typeNomme =TypeNomme of Tds.info_ast *typ
...
type variable = Ident of Tds.info_ast | Var of int*variable | Champ of variable * Tds.info_ast
...
type bloc = instruction list
 and instruction =
  ...
  | Affectation of variable* expression
  | AssignationAdditionRat of variable * expression
  | AssignationAdditionInt of variable * expression
...
type variable = AstType.variable
(* instructions existantes dans notre langage *)
